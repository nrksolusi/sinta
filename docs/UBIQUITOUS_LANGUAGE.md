...
| **Delivery**            | Issue of stock against a sales order (Indonesian: surat jalan)            | Shipment, delivery order, DO  |
...
- A **Purchase order** is fulfilled by one or more **Goods receipts**; a **Sales order** is fulfilled by one or more **Deliveries**
